...
class Mail
{
    ...
    public function __construct($courriel, $uuid)
    {
        ...
        try {
            ...
            $mail->Body ='<h1><a href="'. $path .'"><img src="assets/logo.png" alt="Logo du site ELEPHADS"></a></h1><br><br>
            <p>Bonjour !</p><br><p>Nous vous remercions pour la mise en ligne de votre annonce.</p></br>
